 ...
 * UserInfo
 *
 * @ORM\Table(name="dtb_oauth2_openid_userinfo",
 *     uniqueConstraints={@ORM\UniqueConstraint(name="sub", columns={"sub"})},
 *     indexes={
 *     @ORM\Index(name="dtb_oauth2_openid_userinfo_email_index", columns={"email"}),
 *     @ORM\Index(name="dtb_oauth2_openid_userinfo_preferred_username_index", columns={"preferred_username"})
 *     }
 * )
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Eccube\Repository\OAuth2\OpenID\UserInfoRepository")
 */
class UserInfo extends \Eccube\Entity\AbstractEntity
{
     ...
     * @var string
     *
     * @ORM\Column(name="zoneinfo", type="string", length=255, nullable=true)
     */
    private $zoneinfo;
     ...
     *
     * @ORM\OneToOne(targetEntity="Eccube\Entity\OAuth2\OpenID\UserInfoAddress")
     * @ORM\JoinColumns({
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="menber_id", referencedColumnName="id")
     * })
     */
    private $Member;
     ...
     *
     * @see http://openid-foundation-japan.github.io/openid-connect-core-1_0.ja.html#ScopeClaims
     */
            ...
            case 'address':
                $Results = [
                    'address' => $this->getAddress()->toArray(
                        ['id', '__initializer__', '__cloner__', '__isInitialized__', 'lazyPropertiesDefaults']
                    ),
                ];
                break;
